...
void tela32();
void tela4();
void __attribute__((picinterrupt(("high_priority")))) isrH();
void isr_Timer0();
# 11 "pwm.c" 2
...
void init_lcd()
{
 ...
 lcd_write4(0b00101000,0);
 _delay((unsigned long)((1)*(8000000/4000.0)));
 lcd_write4(0b00101000,0);

 lcd_write4(0b00001000,0);
 lcd_write4(0b00001111,0);
 lcd_write4(0b00000001,0);
 lcd_write4(0b00000110,0);
}
# 122 "./lib_lcd.h"
void lcd_string(const char * ch)
{
    while(*ch != 0) {
        switch(*ch) {
           case '\n': lcd_write4(0xc0,0); break;
           case '\f': lcd_write4(0x01,0); _delay((unsigned long)((2)*(8000000/4000.0))); break;
           default: lcd_write4(*ch,1);
        }
        ch++;
    }
}
...
# 1 "./lib_tecladoMatricial.h" 1
# 16 "./lib_tecladoMatricial.h"
...
char tecla;
__bit flagDeadTime=0;
char contDeadTime=1;
# 37 "./lib_tecladoMatricial.h"
void init_matrixKeyboard() {
    ...
    TRISDbits.RD2 = 0;
    TRISDbits.RD3 = 0;
# 70 "./lib_tecladoMatricial.h"
}
# 80 "./lib_tecladoMatricial.h"
void deadTime_isr()
{
 if(flagDeadTime)
  if(--contDeadTime==0) {
...
char keyboardScan2()
{
 ...
 if (PORTBbits.RB0!=btal1c1) {
  if (btal1c1==1) { btal1c1=0; tecla='1'; flagDeadTime=1; }
  else { btal1c1=1; flagDeadTime=1; } }

 if (PORTBbits.RB1!=btal1c2) {
  if (btal1c2==1) { btal1c2=0; tecla='2'; flagDeadTime=1; }
  else { btal1c2=1; flagDeadTime=1; } }

 if (PORTBbits.RB2!=btal1c3) {
  if (btal1c3==1) { btal1c3=0; tecla='3'; flagDeadTime=1; }
  else { btal1c3=1; flagDeadTime=1; } }
 ...
 if (PORTBbits.RB0!=btal2c1) {
  if (btal2c1==1) { btal2c1=0; tecla='4'; flagDeadTime=1; }
  else { btal2c1=1; flagDeadTime=1; } }

 if (PORTBbits.RB1!=btal2c2) {
  if (btal2c2==1) { btal2c2=0; tecla='5'; flagDeadTime=1; }
  else { btal2c2=1; flagDeadTime=1; } }

 if (PORTBbits.RB2!=btal2c3) {
  if (btal2c3==1) { btal2c3=0; tecla='6'; flagDeadTime=1; }
  else { btal2c3=1; flagDeadTime=1; } }
 ...
 if (PORTBbits.RB0!=btal3c1) {
  if (btal3c1==1) { btal3c1=0; tecla='7'; flagDeadTime=1; }
  else { btal3c1=1; flagDeadTime=1; } }

 if (PORTBbits.RB1!=btal3c2) {
  if (btal3c2==1) { btal3c2=0; tecla='8'; flagDeadTime=1; }
  else { btal3c2=1; flagDeadTime=1; } }

 if (PORTBbits.RB2!=btal3c3) {
  if (btal3c3==1) { btal3c3=0; tecla='9'; flagDeadTime=1; }
  else { btal3c3=1; flagDeadTime=1; } }
 ...
 if (PORTBbits.RB0!=btal4c1) {
  if (btal4c1==1) { btal4c1=0; tecla='*'; flagDeadTime=1; }
  else { btal4c1=1; flagDeadTime=1; } }

 if (PORTBbits.RB1!=btal4c2) {
  if (btal4c2==1) { btal4c2=0; tecla='0'; flagDeadTime=1; }
  else { btal4c2=1; flagDeadTime=1; } }

 if (PORTBbits.RB2!=btal4c3) {
  if (btal4c3==1) { btal4c3=0; tecla='#'; flagDeadTime=1; }
  else { btal4c3=1; flagDeadTime=1; } }
...
void maqTeste() {
    ...
    switch (retsak) {
        case 1:
            ...
            selecao = 1;
            set_duty(duty1[flag]);
            lcd_write4(0x80+1*0x40+2,0);;
            lcd_display3(selecao);
            lcd_write4(0x80+1*0x40+10,0);;
            lcd_display3(pwm);
             if(val == '*'){
                estado = 1;
                selecao = 0;
...
void tela2() {
    ...
    lcd_write4(0x80+0*0x40+13,0);;
    lcd_display3(selecao);
}

void tela31() {
    lcd_string("\fSalvar Posi-1 S\n*-ESC #-ENTER");
    lcd_write4(0x80+0*0x40+15,0);;
    lcd_display3(selecao);
}
...
void __attribute__((picinterrupt(("high_priority")))) isrH() {
    if(INTCONbits.TMR0IF == 1) isr_Timer0();
}
